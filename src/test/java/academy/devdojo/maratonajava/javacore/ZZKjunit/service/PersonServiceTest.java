...
class PersonServiceTest {
    ...
    @Test
    @DisplayName("Should throw NullPointerException with messege person is null")
    void isAdult_TrowException_WhenAgeIsNull() {
    ...
    void ilterRemovingNotAdult_ReturnListWithAdultOnly_WhenListOfPersonWithAdultIsPassed() {
